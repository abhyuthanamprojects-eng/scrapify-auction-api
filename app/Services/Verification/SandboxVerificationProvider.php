    ...
    public function verifyGstin(string $gstin, ?string $businessName = null): NormalizedVerificationResult
    {
        ...
        return new NormalizedVerificationResult(
            ...
            array_merge([
                ...
                'constitution_of_business' => $data['constitution_of_business'] ?? $data['constitutionOfBusiness'] ?? $data['constitution'] ?? null,
                'taxpayer_type' => $data['taxpayer_type'] ?? $data['taxpayerType'] ?? null,
                ...
                $data['legal_name_of_business'] ?? $data['legalName'] ?? $data['legal_name'] ?? null,
                $data['constitution_of_business'] ?? $data['constitutionOfBusiness'] ?? $data['constitution'] ?? null,
                $data['taxpayer_type'] ?? $data['taxpayerType'] ?? null,
                $data['gstin'] ?? $data['GSTIN'] ?? $gstin,
            )),
            $rawStatus ?: null,

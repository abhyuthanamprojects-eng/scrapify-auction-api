...
class PlatformConfigController extends Controller
{
    public function show(): JsonResponse
    {
        return response()->json([
            ...
            'web_registration_fee_required' => GeneralSettings::bool('web_registration_fee_required', true),
            'mobile_registration_fee_required' => GeneralSettings::bool('mobile_registration_fee_required', false),
            'currency' => 'INR',
            'registration_payment_method' => 'manual_bank_transfer',
            'registration_bank_details' => [
                'bank_name' => GeneralSettings::string('registration_bank_name', 'State Bank of India'),
                'account_name' => GeneralSettings::string('registration_bank_account_name', 'ABHYUTHANAM INDUSTRIES PRIVATE LIMITED'),
                'account_number' => GeneralSettings::string('registration_bank_account_number', '45393705791'),
                ...
                'address' => GeneralSettings::string('registration_bank_address', 'Plot No I-646, Khasra No 664, Hari Nagar, Jaitpur Road, Near Om Nursery Complex, Badarpur, New Delhi 110044'),
            ],
            ...
            'identity_verification_enabled' => GeneralSettings::bool('digilocker_enabled', false),
            ...
            'firebase' => [
                ...
                'projectId' => GeneralSettings::string('firebase_project_id', ''),
    ...
    public function update(Request $request): JsonResponse
    {
        $data = $request->validate([
            ...
            'web_registration_fee_required' => ['sometimes', 'boolean'],
            'mobile_registration_fee_required' => ['sometimes', 'boolean'],
            'registration_bank_name' => ['sometimes', 'string', 'max:160'],
            'registration_bank_account_name' => ['sometimes', 'string', 'max:180'],
            'registration_bank_account_number' => ['sometimes', 'string', 'max:40'],
